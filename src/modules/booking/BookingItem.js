...
const BookingItem = ({ to = "", title = "", description = "", amount = "", text = "", category = "Example", imageClass="h-[200px]" }) => {
    return (
        <Link to={to} className="w-full">
            <BookingImage className={`${imageClass}`} ></BookingImage>
            <div className="py-4">
                <BookingCategory icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div className="flex items-start justify-between mb-5 gap-x-5">
                    <BookingMeta amount="2,000" text="visitors"></BookingMeta>
                    <BookingMeta amount="173" text="places"></BookingMeta>
                </div>
